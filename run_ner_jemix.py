...
"""
Fine-tuning the library models for token classification (ner pos).
"""
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.dataset_name == 'ner':
            # Downloading and loading a dataset .
            datasets = load_dataset('ner_generator.py')
        elif data_args.dataset_name == 'pos':
            datasets = load_dataset('pos_generator.py')
